...
# Folder where Flask chart images will be saved
...
# Create chart folder automatically if it does not exist
os.makedirs(
    CHART_DIR,
    exist_ok=True
)
...
# Check whether chicago_crimes table exists
table_names = [
    table[0]
    for table in tables
]
...
if "chicago_crimes" not in table_names:
    ...
    print(
        "\nPlease check the table name created by Usecase1.py."
    )
...
# Use the correct column names depending on what Usecase1 created
...
plt.title(
    "Arrest Percentage for Top 10 Crime Types"
)
...
plt.title(
    "Crime Frequency by Month and Day of Week"
)
...
plt.title(
    "Top 10 Community Areas by Crime Frequency"
)
